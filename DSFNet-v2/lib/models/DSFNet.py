...
from common import ASPP, SCAM, SPPELAN, CoordAtt
...
class DLASeg(nn.Module):
    def __init__(self, heads, final_kernel,
        ...
        self.sppelan=SPPELAN(16,16,64)
        self.coordatt=CoordAtt(3,3)
        self.SCAM_0=SCAM(16)
        self.SCAM_1=SCAM(32)
        self.SCAM_2=SCAM(64)
        self.SCAM_3=SCAM(128)
        self.SCAM_4=SCAM(256)
    ...
    def forward(self, x):
        ...
        #直接加个位置注意力-dwj
        layersspatial = self.base(xx+self.coordatt(xx))
        #5个特征图
        layersspatial[0]=self.SCAM_0(layersspatial[0])
        layersspatial[1]=self.SCAM_1(layersspatial[1])
        layersspatial[2]=self.SCAM_2(layersspatial[2])
        layersspatial[3]=self.SCAM_3(layersspatial[3])
        layersspatial[4]=self.SCAM_4(layersspatial[4])
        ...
        #dwj-2024-06-22添加池化模块
        y[-1]=self.sppelan(y[-1])
